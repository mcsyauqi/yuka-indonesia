...
<p>Hasil audit setelah deploy kedua (<code>pe607bsuagjwcah2rjnurhc1</code>, status <strong>finished</strong>) sempat ditulis sebagai <em>nol penyebutan otoritas tanpa tautan</em>. Angka itu overstate dan sudah dikoreksi. Pemeriksaan ulang pada 3 Agustus 2026 menemukan <strong>3 penyebutan otoritas yang belum tertaut di kalimatnya sendiri</strong>: (1) rekomendasi AAP untuk anak usia 6 tahun ke atas di artikel ADHD, yang tidak punya tautan aap.org sama sekali di halaman itu (nol dari 30 tautan eksternal); (2) kutipan langsung WHO tentang prevalensi autisme di negara berpenghasilan rendah dan menengah; (3) kriteria DSM-5 "6 dari 9 gejala" di artikel ADHD. Nomor 2 dan 3 otoritasnya sudah tertaut di bagian lain halaman yang sama, tetapi belum di kalimat yang memuat klaimnya. Ketiganya ditutup pada 3 Agustus 2026, dan rekomendasi AAP kini ditautkan ke pedoman praktik klinis AAP 2019 di jurnal Pediatrics.</p>
